...
const Image = styled(Box)`
    background: #4abdac url(${logo}) center 85% no-repeat;
                ...
                <Box style={{display: 'flex', height: '100%'}}>
                    ...
                    </Image>
                    {
                        ...
                        <Wrapper>
                            ...
                            { error && <Error>Please enter Username</Error> }
                            <TextField variant="standard" onChange={(e) => onValueChange(e)} name='password' label='Enter Password' />
                            <Text>By continuing, you agree to Toyjoy's Terms of Use and Privacy Policy.</Text>
